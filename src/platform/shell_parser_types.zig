    ...
    return struct {
        ...
        fn mapNodeKind(node_type: ?[*:0]const u8) NodeKind {
            ...
            const table = .{
                ...
                .{ "boolean_literal", K.boolean_literal },
                ...
                .{ "paren_expr", K.apply_expr },
                .{ "data_decl", K.type_decl },
                .{ "theorem_decl", K.prove_decl },
                .{ "import_decl", K.unknown },
                .{ "fact_decl", K.fact_decl },
                .{ "rule_decl", K.rule_decl },
                .{ "query_decl", K.query_decl },
                .{ "ERROR", K.err_node },
            };
