...
pub const CommandTag = enum {
    exit, help, stats, doc, load,
    cmd_type, infer, qtt, dep, hole,
    prove, theorem, axiom, proof, theorems, skill,
    simplify, rewrite, explain, eval, quote, latex, let_var, derive, solve, expand, integrate, plot,
    fact, rule, ask, run_star, query,
    transpile, compile, c_out,
    memo, trace, optimize, hook,
    onto, isa, meta, subst, sexpr,
    spawn, threads, await, swarm,
    mlcpd_parse, mlcpd_convert, mlcpd_stats,
    mcp_serve,
};
